...
/// Parse a pair of floating-point separated by a comma as a complex number.
...
/// corresponding poin on the complex plane.
/// 
...
/// left and lower_right corners of the pixel buffer.
